		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Products",
									"targetURL": "#comstelliumdemoproducts-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comstelliumdemoproducts-display": {
								"semanticObject": "comstelliumdemoproducts",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.stellium.demo.products",
									"url": sap.ui.require.toUrl("com/stellium/demo/products")
								}
							}
						}
					}
